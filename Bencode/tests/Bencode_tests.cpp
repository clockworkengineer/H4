...
TEST_CASE("Decode generated exceptions", "[Bencode][Decode][Exceptions]")
{
  ...
  {
    REQUIRE_THROWS_AS(bEncode.decodeBuffer(nullptr), std::invalid_argument);
    REQUIRE_THROWS_WITH(bEncode.decodeBuffer(nullptr), "nullptr/empty string passed to be decoded.");
    REQUIRE_THROWS_AS(bEncode.decodeBuffer(""), std::invalid_argument);
    REQUIRE_THROWS_WITH(bEncode.decodeBuffer(""), "nullptr/empty string passed to be decoded.");
  }
...
TEST_CASE("Decode erronous torrent files using decodeFile", "[Bencode][Decode][Torrents]")
{
  ...
  SECTION("Decode singlefileerror.torrent and check value ", "[Bencode][Decode][Torrents]")
  {
  ...
  SECTION("Decode multifileerror.torrent and check value ", "[Bencode][Decode][Torrents]")
  {
